# Security Policy for pin-actions

## Threat Model

pin-actions is designed for **supply-chain trust**: ensuring GitHub Actions are pinned to known-good SHAs rather than floating tags or branches.
...
pin-actions prioritizes **safety over convenience**:
...
- A failed pin-actions run is better than an incorrect pin
...
### PR Evidence
- Each PR opened by pin-actions includes a "Why this SHA?" section
...
pin-actions supports explicit enforcement scoping and exceptions so CI remains strict but practical:
...
If you discover a security vulnerability in pin-actions:
